...
export default function OrderMapPage() {
  ...
  if (loading) {
    return <div className="text-center mt-20 text-lg">Loading order details...</div>;
  }
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 ml-20 sm:ml-24 p-6">
        ...
        <div className="bg-white p-8 rounded-xl shadow-md">
          ...
          {locationError && <div className="text-red-500 mb-4">{locationError}</div>}
          <OrderMap driverLocation={driverLocation} customerLocation={customerLocation} />
        </div>
      </div>
    </div>
  );
